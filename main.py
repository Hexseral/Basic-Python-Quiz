...
if __name__ == '__main__':
    ...
    q1 = Question(a = 1, o =[0, 1, 5, 6], q = "What is 6 divided by 6?")
    ...
    q3 = Question(a = 6, o =[4, 3, 6, 8], q = "What is the square root of 36?")
    # adds question three into the list.
    questions.append(q3)

    q4 = Question(a = 6, o =[4, 3, 6, 8], q = "What is the square root of 36?")
    # adds question four into the list.
    questions.append(q4)

    q5 = Question(a = 6, o =[4, 3, 6, 8], q = "What is the square root of 36?")
    # adds question five into the list.
    questions.append(q5)

    name = input("Hello! \n Welcome to the SAT General Knowledge Practice Test.\n Please start by entering your Name:\n")
    ...
    for x in questions:
        ...
        if user_input == x.answer:
            ...
            print("Incorrect.", "the Correct answer was:", x.answer)
